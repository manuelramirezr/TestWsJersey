 ...
 */
//@javax.ejb.Stateless
@Path("com.koghi.documentacion.modelo.hito")
public class HitoFacadeREST extends AbstractFacade<Hito> {
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("DocKoghiPU");
    private EntityManager em = emf.createEntityManager();

    public HitoFacadeREST() {
        super(Hito.class);
    }
    ...
    public Hito create(Hito entity) {
    ...
    @Path("{id}")
    @Produces({"application/xml", "application/json"}) 
    public Hito remove(@PathParam("id") Long id) {
    ...
    @Path("{id}")
    @Produces({"application/xml", "application/json"})
    public Hito find(@PathParam("id") Long id) {
